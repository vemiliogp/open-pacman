...
- `maze.js`: 28×31 maze written as 31 strings of 28 chars, parsed to a numeric matrix. Cell values: `0` empty, `1` wall, `2` dot, `3` ghost-pen door, `4` power pellet. Symmetric across the vertical center axis; row 14 is the wrap-around tunnel.
